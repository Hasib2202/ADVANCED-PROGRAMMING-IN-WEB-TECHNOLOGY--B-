...
//   // Filter the data by ID based on search term
//   const filteredData = data.filter((user: any) =>
//     user.id.toString().includes(searchTerm)
//   );

//   // Function to handle the update action (navigates to the update page)
//   const handleUpdate = (userId: number) => {
//     router.push(`/update-user/${userId}`); // Navigate to update page with userId
//   };
...
//                         onClick={() => handleUpdate(user.id)} // Use handleUpdate for navigation
//                       >
//                         Update
//                       </button>
//                     </td>
...
export default function ShowData() {
  ...
  const handleUpdate = (userId: number) => {
    router.push(`manager/update-user/${userId}`); // Navigate to update page with userId
  };
